class JailBookingsController < ApplicationController
  ...
  private
    ...
    def jail_booking_params
      params.require(:jail_booking).permit(:number, :full_name, :age, :inmate_number, :custody_status, :housing_location, :received_date_time, :arrested_by, :released_date_tiem, :city, :state)
    end
end
