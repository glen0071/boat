...
BAB_TABLETS_ARRAY = [
  {
    title: "Qayyúmu'l-Asmá'",
    alt_titles: 'Maintainer of the Divine Names',
  ...
  },
  {
    ...
    location: 'Shiraz, Iran',
    notes: 'collection of fourteen prayers, mostly to be recited on specific holy days and festivals'
  },
  {
    title: "Khasá'il-i-sab`ih",
    alt_title: '',
  ...
  },
  {
    ...
    pub_date: 'September 1844 – June 1845',
    location: 'sailing to Bushehr, Iran',
    notes: 'During his  nine and a half month pilgrimage to Mecca'
  },
  {
    title: "Sahífih baynu'l-haramayn",
    alt_title: 'Treatise Between the Two Sanctuaries',
    pub_date: 'September 1844 – June 1845',
  ...
  },
  {
    ...
    location: 'Isfahan',
    notes: "This work, of fifty pages' length, was revealed in two hours in response to a question by Governor Manouchehr Khan Gorji. It discusses the special prophethood of Muhammad, an important subject discussed in debates between Muslims and Christians"
  },
  {
    title: "Tafsír-i-Súrih-i-va'l-`asr",
    alt_title: 'Commentary on the Surah al-‘Aṣr',
    pub_date: 'September 1844 – June 1845',
    location: 'Isfahan',
  ...
  {
    title: "Dalá'il-i-Sab'ih'",
    alt_title: 'Seven Proofs',
    pub_date: 'May 22, 1844',
    location: 'Maku',
    notes: ''
  },
  {
    title: "Kitabu'l-Asmá'",
    alt_title: 'The Book of Names',
    pub_date: 'July 1850',
    location: 'Chihríq',
    notes: ''
  },
  {
    title: "Kitáb-i-panj sha'n",
    alt_title: 'Book of Five Grades',
...
BAHA_TABLETS_ARRAY = [
  {
    title: 'Rashḥ-i-ʻAmá',
    alt_title: 'Prinkling from a Cloud',
    pub_date: '1852',
    location: 'Síyáh-Chál, Tehran, Iran',
    notes: "First known writing of Bahá'u'lláh after he received a vision of His mission as a Messenger from God"
  },
  {
    title: 'Lawḥ-i-Kulluʼ-Ṭaʻám',
