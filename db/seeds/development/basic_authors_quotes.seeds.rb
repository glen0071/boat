...
truth_quote.topics << Topic.find_or_create_by(name: 'Truthfulness')
...
happy_quote.topics << Topic.find_or_create_by(name: 'Happiness')
...
concentrate_quote.topics << Topic.find_or_create_by(name: 'Concentration')
